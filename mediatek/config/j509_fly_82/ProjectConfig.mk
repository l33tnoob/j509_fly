...
CUSTOM_HAL_IMGSENSOR=ov8825_mipi_raw_2lane imx179_mipi_raw_2lane sp2518_yuv hi257_yuv

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS=ov8825af ad5823af  dummy_lens
...
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=imx179_mipi_raw_2lane

# lens driver config for main camera (2nd solution)
CUSTOM_HAL_MAIN_BACKUP_LENS=ad5823af
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR=hi257_yuv
...
CUSTOM_KERNEL_IMGSENSOR=ov8825_mipi_raw_2lane imx179_mipi_raw_2lane sp2518_yuv hi257_yuv
...
CUSTOM_KERNEL_LENS=ov8825af ad5823af  dummy_lens
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR=imx179_mipi_raw_2lane

# lens driver config for main camera (2nd solution)
CUSTOM_KERNEL_MAIN_BACKUP_LENS=ad5823af
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR=hi257_yuv
...
CUSTOM_KERNEL_TOUCHPANEL=GT9XX_2
...
CUSTOM_LK_LCM=otm9605a_dsi_vdo_djn_qhd_ips otm9605a_dsi_vdo_hlt_qhd_ips
...
#modify by liuxianbang for cts 20140512 (start)
MTK_2SDCARD_SWAP=yes
#modify by liuxianbang for cts 20140512 (end)
...
#modify xieshanlin BUG_ID:JWLJ-307 20140403(start)
#MTK_IPO_SUPPORT=yes
MTK_IPO_SUPPORT=no
#modify xieshanlin BUG_ID:JWLJ-307 20140403(end)
...
CUSTOM_MODEM=sky77590_gsm4_w1258_mt6582_hspa_gemini
...
BOOT_LOGO=j509_fly_82

# To choose kernel LCM driver name
CUSTOM_KERNEL_LCM=otm9605a_dsi_vdo_djn_qhd_ips otm9605a_dsi_vdo_hlt_qhd_ips

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm9605a_dsi_vdo_djn_qhd_ips otm9605a_dsi_vdo_hlt_qhd_ips
...
MTK_PRODUCT_LOCALES=ru_RU uk_UA en_US
...
# User can input ASCII string which is showed in About phone and bootimg header.
CUSTOM_BUILD_VERNO=SW12_FLY_IQ4413_2014_08_18
# add for internal verno customization by jinhaijian showed in 9375
CUSTOM_INTERNAL_BUILD_VERNO= J509_FLY_B1A_V0.6.6_S0818
...
RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1 = Evo^Chic^3
...
#add BUG_ID:JWLJ-595 huangkunming 20140429 (start)
RGK_SHOW_USER2ROOT = no
#add BUG_ID:JWLJ-595 huangkunming 20140429 (end)

#add J509_GPS MEMORY DESENSE ISSUE penny 20140521 (start)
RGK_KERNEL_MEMORY_DDR_912_CONFIG = yes
#add J509_GPS MEMORY DESENSE ISSUE penny 20140521 (end)
