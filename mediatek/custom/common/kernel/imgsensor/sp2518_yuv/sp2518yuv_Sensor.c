...
static kal_uint32 SP2518_g_fPV_PCLK = 26; //24
...
void SP2518_night_mode(kal_bool bEnable)
{
	...
	/*#ifdef SP2518_24M_72M		
				...
				SP2518_write_cmos_sensor(0xfd,0x00);	
#endif*/  
			//capture preview night 26M 2pll 50hz fix 6FPS maxgain 
				SP2518_write_cmos_sensor(0xfd,0x00);
				SP2518_write_cmos_sensor(0x03,0x01);
				SP2518_write_cmos_sensor(0x04,0xd4);
				SP2518_write_cmos_sensor(0x09,0x02);
				...
				SP2518_write_cmos_sensor(0xd0,0xe0);
				SP2518_write_cmos_sensor(0xd1,0x04);
				SP2518_write_cmos_sensor(0xd7,0x4a);//exp_nr_outd_8lsb
				SP2518_write_cmos_sensor(0xd8,0x00);
				SP2518_write_cmos_sensor(0xd9,0x4e);//exp_outd_nr_8lsb
				SP2518_write_cmos_sensor(0xda,0x00);
				SP2518_write_cmos_sensor(0xfd,0x00);	
...
/*#ifdef SP2518_24M_72M		
...
#endif*/
			//capture preview night 26M 2pll 60hz fix 6FPS maxgain
			SP2518_write_cmos_sensor(0xfd,0x00);
			SP2518_write_cmos_sensor(0x03,0x01);
			SP2518_write_cmos_sensor(0x04,0x86);
			SP2518_write_cmos_sensor(0x09,0x02);
			...
			SP2518_write_cmos_sensor(0xd0,0x14);
			SP2518_write_cmos_sensor(0xd1,0x05);
			SP2518_write_cmos_sensor(0xd7,0x3d);//exp_nr_outd_8lsb
			SP2518_write_cmos_sensor(0xd8,0x00);
			SP2518_write_cmos_sensor(0xd9,0x41);//exp_outd_nr_8lsb
			SP2518_write_cmos_sensor(0xda,0x00);
			SP2518_write_cmos_sensor(0xfd,0x00);
			}
       	 }/*capture night mode*/
...
/*#ifdef SP2518_24M_72M		
	...
	else /*normal mode settings*/
	{
		...
		/*#ifdef SP2518_24M_72M
				...
				#endif*/
				//capture preview daylight 26M 2pll 50hz fix 9FPS maxgain
			SP2518_write_cmos_sensor(0xfd,0x00);
			SP2518_write_cmos_sensor(0x03,0x02);
			SP2518_write_cmos_sensor(0x04,0xbe);
			SP2518_write_cmos_sensor(0x09,0x00);
			SP2518_write_cmos_sensor(0x0a,0xb9); 
			SP2518_write_cmos_sensor(0xf0,0x75);
			SP2518_write_cmos_sensor(0xf1,0x00);
			SP2518_write_cmos_sensor(0xfd,0x01);	
			SP2518_write_cmos_sensor(0x90,0x0b);	
	...
	#endif*/
		//capture preview daylight 26M 2pll 60hz fix 9FPS maxgain
			SP2518_write_cmos_sensor(0xfd,0x00);
			SP2518_write_cmos_sensor(0x03,0x02);
			SP2518_write_cmos_sensor(0x04,0x4c);
			SP2518_write_cmos_sensor(0x09,0x00);
			SP2518_write_cmos_sensor(0x0a,0xb3); 
			SP2518_write_cmos_sensor(0xf0,0x62);
			SP2518_write_cmos_sensor(0xf1,0x00);
			SP2518_write_cmos_sensor(0xfd,0x01);	
			SP2518_write_cmos_sensor(0x90,0x0d);	
...
#endif*/
			//capture preview daylight 26M 9pll 60hz fix 9FPS maxgain
			SP2518_write_cmos_sensor(0xfd,0x00);
			SP2518_write_cmos_sensor(0x03,0x02);
			SP2518_write_cmos_sensor(0x04,0x4c);
			SP2518_write_cmos_sensor(0x09,0x00);
...
SP2518_write_cmos_sensor(0xfd,0x01);
SP2518_write_cmos_sensor(0x64,0x24);
SP2518_write_cmos_sensor(0x65,0x1e);
SP2518_write_cmos_sensor(0x66,0x22);
SP2518_write_cmos_sensor(0x67,0x20);
SP2518_write_cmos_sensor(0x68,0x24);
SP2518_write_cmos_sensor(0x69,0x1e);
SP2518_write_cmos_sensor(0x6a,0x20);
SP2518_write_cmos_sensor(0x6b,0x20);
SP2518_write_cmos_sensor(0x6c,0x24);
SP2518_write_cmos_sensor(0x6d,0x1e);
SP2518_write_cmos_sensor(0x6e,0x20);
SP2518_write_cmos_sensor(0x6f,0x20);
SP2518_write_cmos_sensor(0xb8,0x09);
SP2518_write_cmos_sensor(0xb9,0x1d);
SP2518_write_cmos_sensor(0xba,0x0a);
SP2518_write_cmos_sensor(0xbb,0x13);
SP2518_write_cmos_sensor(0xbc,0x09);
SP2518_write_cmos_sensor(0xbd,0x1a);
SP2518_write_cmos_sensor(0xbe,0x0a);
SP2518_write_cmos_sensor(0xbf,0x10);
SP2518_write_cmos_sensor(0xc0,0x09);
SP2518_write_cmos_sensor(0xc1,0x1a);
SP2518_write_cmos_sensor(0xc2,0x0a);
SP2518_write_cmos_sensor(0xc3,0x13);
SP2518_write_cmos_sensor(0xfd,0x01);
SP2518_write_cmos_sensor(0xde,0x0f);
SP2518_write_cmos_sensor(0xfd,0x00);
SP2518_write_cmos_sensor(0x57,0x02);
SP2518_write_cmos_sensor(0x58,0x02);
SP2518_write_cmos_sensor(0x56,0x08);
SP2518_write_cmos_sensor(0x59,0x10);
SP2518_write_cmos_sensor(0x5a,0xd0);
SP2518_write_cmos_sensor(0xc4,0xd0);
SP2518_write_cmos_sensor(0x43,0xa0);
SP2518_write_cmos_sensor(0xad,0x40);
SP2518_write_cmos_sensor(0x4f,0xd0);
...
SP2518_write_cmos_sensor(0xb6,0xd0);
SP2518_write_cmos_sensor(0xb7,0xd0);
SP2518_write_cmos_sensor(0xb8,0x40);
SP2518_write_cmos_sensor(0xb9,0x20);
SP2518_write_cmos_sensor(0xfd,0x01);
SP2518_write_cmos_sensor(0x50,0x04);
SP2518_write_cmos_sensor(0x51,0x02);
SP2518_write_cmos_sensor(0x52,0x0c);
...
SP2518_write_cmos_sensor(0xa0,0xb1);
SP2518_write_cmos_sensor(0xa1,0xf4);
SP2518_write_cmos_sensor(0xa2,0xdb);
...
SP2518_write_cmos_sensor(0xac,0xa6);
SP2518_write_cmos_sensor(0xad,0xda);
SP2518_write_cmos_sensor(0xae,0x00);
SP2518_write_cmos_sensor(0xaf,0xf2);
SP2518_write_cmos_sensor(0xb0,0xa6);
SP2518_write_cmos_sensor(0xb1,0xe8);
SP2518_write_cmos_sensor(0xb2,0x00);
SP2518_write_cmos_sensor(0xb3,0xe7);
SP2518_write_cmos_sensor(0xb4,0x99);
SP2518_write_cmos_sensor(0xb5,0x0c);
SP2518_write_cmos_sensor(0xb6,0x33);
SP2518_write_cmos_sensor(0xb7,0x0c);
SP2518_write_cmos_sensor(0xfd,0x00);
...
SP2518_write_cmos_sensor(0xd3,0x79);
SP2518_write_cmos_sensor(0xd4,0x79);
SP2518_write_cmos_sensor(0xd6,0x79);
SP2518_write_cmos_sensor(0xd7,0x79);
...
SP2518_write_cmos_sensor(0x8c,0x10);
SP2518_write_cmos_sensor(0x8d,0x21);
SP2518_write_cmos_sensor(0x8e,0x39);
SP2518_write_cmos_sensor(0x8f,0x5f);
SP2518_write_cmos_sensor(0x90,0x7d);
SP2518_write_cmos_sensor(0x91,0x92);
SP2518_write_cmos_sensor(0x92,0xa2);
SP2518_write_cmos_sensor(0x93,0xaf);
SP2518_write_cmos_sensor(0x94,0xba);
SP2518_write_cmos_sensor(0x95,0xc3);
SP2518_write_cmos_sensor(0x96,0xcc);
SP2518_write_cmos_sensor(0x97,0xd3);
SP2518_write_cmos_sensor(0x98,0xda);
SP2518_write_cmos_sensor(0x99,0xe1);
SP2518_write_cmos_sensor(0x9a,0xe8);
SP2518_write_cmos_sensor(0x9b,0xf0);
SP2518_write_cmos_sensor(0xfd,0x01);
SP2518_write_cmos_sensor(0x8d,0xf8);
...
SP2518_write_cmos_sensor(0xde,0xa8);
...
SP2518_write_cmos_sensor(0xe5,0x08);
SP2518_write_cmos_sensor(0xe7,0x08);
...
SP2518_write_cmos_sensor(0xeb,0x18);
...
SP2518_write_cmos_sensor(0x35,0x40); // 40
...
UINT32 SP2518YUVSensorSetting(FEATURE_ID iCmd, UINT16 iPara)
{
    ...
    #ifdef DEBUG_SENSOR_SP2518  //hill 0320
    return TRUE;
    #endif
    switch (iCmd) 
	{
