...
#define SP0A19_P0_0xed  0x90//indoor ae upper bound
#define SP0A19_P0_0xf7  0x80 //indoor ae target//0x98 fs
#define SP0A19_P0_0xf8  0x78//0x90 fs
#define SP0A19_P0_0xec  0x80//indoor ae low bound

#define SP0A19_P0_0xef  0x6c//out door
#define SP0A19_P0_0xf9  0x68
#define SP0A19_P0_0xfa  0x60
#define SP0A19_P0_0xee  0x5c
 ...
 u8 SP0a19_Initialize_from_T_Flash()
{
	...
	//	fp = filp_open("/storage/sdcard0/sp0a19_sd.dat", O_RDONLY , 0); 
      ...
      //  return -1; 
		...
		printk("SP0a19_Initialize_from_T_Flash Open File Success\n");
	...
	while (curr_ptr < (data_buff + file_size))
	{
		...
		if (strcmp((const char *)func_ind, "REG") == 0)		/* REG */
		{
			...
			SP0a19_Init_Reg[i].init_reg = strtol((const char *)curr_ptr, 16);
			curr_ptr += 5;	/* Skip "00, 0x" */
		
			SP0a19_Init_Reg[i].init_val = strtol((const char *)curr_ptr, 16);
			curr_ptr += 4;	/* Skip "00);" */
		...
		else									/* DLY */
		{
			...
			SP0a19_Init_Reg[i].init_val = strtol((const char *)curr_ptr,  10);	/* Get the delay ticks, the delay should less then 50 */
		}
		i++;
	   ...
	   if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
		{
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                            #else
                            // 26M 1分频 50Hz 6-6fps night preview
					SP0A19_write_cmos_sensor(0xfd,0x00); 
					SP0A19_write_cmos_sensor(0x03,0x00); //0x00
					SP0A19_write_cmos_sensor(0x04,0x5d); //0x99
					SP0A19_write_cmos_sensor(0x06,0x00); 
					SP0A19_write_cmos_sensor(0x09,0x0d); 
					SP0A19_write_cmos_sensor(0x0a,0x10); 
					SP0A19_write_cmos_sensor(0xf0,0x1f); 
					SP0A19_write_cmos_sensor(0xf1,0x00); 
					SP0A19_write_cmos_sensor(0xfd,0x01); 
					SP0A19_write_cmos_sensor(0x90,0x10); 
					SP0A19_write_cmos_sensor(0x92,0x01); 
					SP0A19_write_cmos_sensor(0x98,0x1f); 
					SP0A19_write_cmos_sensor(0x99,0x00); 
					SP0A19_write_cmos_sensor(0x9a,0x01); 
					SP0A19_write_cmos_sensor(0x9b,0x00); 
					SP0A19_write_cmos_sensor(0xfd,0x01); 
					SP0A19_write_cmos_sensor(0xce,0xf0); 
					SP0A19_write_cmos_sensor(0xcf,0x01); 
					SP0A19_write_cmos_sensor(0xd0,0xf0); 
					SP0A19_write_cmos_sensor(0xd1,0x01); 
					SP0A19_write_cmos_sensor(0xfd,0x00); 
				...
				else if(sp0a19_isBanding == 1)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                                #else
                                // 26M 1分频 60Hz 6-6fps night preview
					SP0A19_write_cmos_sensor(0xfd,0x00); 
					SP0A19_write_cmos_sensor(0x03,0x00); 
					SP0A19_write_cmos_sensor(0x04,0x4e); 
					SP0A19_write_cmos_sensor(0x06,0x00); 
					SP0A19_write_cmos_sensor(0x09,0x0c); 
					SP0A19_write_cmos_sensor(0x0a,0xf5); 
					SP0A19_write_cmos_sensor(0xf0,0x1a); 
					SP0A19_write_cmos_sensor(0xf1,0x00); 
					SP0A19_write_cmos_sensor(0xfd,0x01); 
					SP0A19_write_cmos_sensor(0x90,0x14); 
					SP0A19_write_cmos_sensor(0x92,0x01); 
					SP0A19_write_cmos_sensor(0x98,0x1a); 
					SP0A19_write_cmos_sensor(0x99,0x00); 
					SP0A19_write_cmos_sensor(0x9a,0x01); 
					SP0A19_write_cmos_sensor(0x9b,0x00); 
					SP0A19_write_cmos_sensor(0xfd,0x01); 
					SP0A19_write_cmos_sensor(0xce,0x08); 
					SP0A19_write_cmos_sensor(0xcf,0x02); 
					SP0A19_write_cmos_sensor(0xd0,0x08); 
					SP0A19_write_cmos_sensor(0xd1,0x02); 
					SP0A19_write_cmos_sensor(0xfd,0x00); 
                                #endif
				}
	         ...
	         if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
	          {
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                            #else
                            // 26M 1分频 50Hz 8-8fps nor preview
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0x03,0x00);//0x00
SP0A19_write_cmos_sensor(0x04,0x7b);//0xba
SP0A19_write_cmos_sensor(0x06,0x00);
...
SP0A19_write_cmos_sensor(0xfd,0x00);
				...
				else if(sp0a19_isBanding == 1)
				{
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
                                #else 
                                // 26M 1分频 60Hz 8-8fps daylight preview
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);//0x00
					SP0A19_write_cmos_sensor(0x04,0x66);//0x99
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x09);
			...
			else 
			{
				...
				{
				#if 1
                            // 26M 1分频 50Hz 8-8fps night preview
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0x03,0x00);//0x00
SP0A19_write_cmos_sensor(0x04,0x7b);//0xba
SP0A19_write_cmos_sensor(0x06,0x00);
...
SP0A19_write_cmos_sensor(0x36,0x17);
SP0A19_write_cmos_sensor(0x37,0x15);
SP0A19_write_cmos_sensor(0x38,0x15);
SP0A19_write_cmos_sensor(0x39,0x12);
SP0A19_write_cmos_sensor(0x3a,0x12);
SP0A19_write_cmos_sensor(0x3b,0x12);
SP0A19_write_cmos_sensor(0x3c,0x12);
SP0A19_write_cmos_sensor(0x3d,0x15);
SP0A19_write_cmos_sensor(0x3e,0x17);
SP0A19_write_cmos_sensor(0x3f,0x15);
SP0A19_write_cmos_sensor(0x40,0x18);
SP0A19_write_cmos_sensor(0x41,0x04);
SP0A19_write_cmos_sensor(0x42,0x07);
SP0A19_write_cmos_sensor(0x43,0x05);
SP0A19_write_cmos_sensor(0x44,0x00);
SP0A19_write_cmos_sensor(0x45,0x00);
SP0A19_write_cmos_sensor(0x46,0x00);
SP0A19_write_cmos_sensor(0x47,0x00);
SP0A19_write_cmos_sensor(0x48,0x05);
SP0A19_write_cmos_sensor(0x49,0x00);
SP0A19_write_cmos_sensor(0x4a,0x05);
SP0A19_write_cmos_sensor(0x4b,0x02);
SP0A19_write_cmos_sensor(0x4c,0x02);
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0xfd,0x01);
...
SP0A19_write_cmos_sensor(0x66,0xfb);
SP0A19_write_cmos_sensor(0x67,0x71);
SP0A19_write_cmos_sensor(0x68,0x96);
SP0A19_write_cmos_sensor(0x69,0xc1);
SP0A19_write_cmos_sensor(0x6a,0xee);
SP0A19_write_cmos_sensor(0x6b,0x91);
SP0A19_write_cmos_sensor(0x6c,0xbc);
...
SP0A19_write_cmos_sensor(0x6d,0xae);
SP0A19_write_cmos_sensor(0x6e,0xd7);
SP0A19_write_cmos_sensor(0x6f,0xaf);
SP0A19_write_cmos_sensor(0x70,0xd8);
SP0A19_write_cmos_sensor(0xfd,0x01);
...
SP0A19_write_cmos_sensor(0x81,0xd0);
SP0A19_write_cmos_sensor(0x82,0xa0);
SP0A19_write_cmos_sensor(0x83,0x80);
SP0A19_write_cmos_sensor(0x84,0x40);
SP0A19_write_cmos_sensor(0x85,0xd0);
SP0A19_write_cmos_sensor(0x86,0xa0);
SP0A19_write_cmos_sensor(0x87,0x80);
SP0A19_write_cmos_sensor(0x88,0x40);
SP0A19_write_cmos_sensor(0x5a,0xee);
...
SP0A19_write_cmos_sensor(0xe5,0x06); //rangek_neg_outdoor
SP0A19_write_cmos_sensor(0xd3,0x06); //rangek_pos_outdoor   
SP0A19_write_cmos_sensor(0xd7,0x06); //range_base_outdoor   
SP0A19_write_cmos_sensor(0xe6,0x08); //rangek_neg_normal
SP0A19_write_cmos_sensor(0xd4,0x08); //rangek_pos_normal 
SP0A19_write_cmos_sensor(0xd8,0x08); //range_base_normal  
SP0A19_write_cmos_sensor(0xe7,0x13); //rangek_neg_dummy  //0x12 kavie 20131211
SP0A19_write_cmos_sensor(0xd5,0x13); //rangek_pos_dummy  //0x12 kavie 20131211
SP0A19_write_cmos_sensor(0xd9,0x13); //range_base_dummy  //0x12 kavie 20131211	    
SP0A19_write_cmos_sensor(0xd2,0x28); //rangek_neg_lowlight   //0x20 kavie 20131211
SP0A19_write_cmos_sensor(0xd6,0x28); //rangek_pos_lowlight   //0x20 kavie 20131211
SP0A19_write_cmos_sensor(0xda,0x28); //range_base_lowlight  //0x20 kavie 20131211
SP0A19_write_cmos_sensor(0xe8,0x20);//sharp_fac_pos_outdoor  //0x20 kavie 20131211
SP0A19_write_cmos_sensor(0xec,0x2c);//sharp_fac_neg_outdoor  /0x2c kavie 20131211
SP0A19_write_cmos_sensor(0xe9,0x20);//sharp_fac_pos_nr         //0x20 kavie 20131211
SP0A19_write_cmos_sensor(0xed,0x2c);//sharp_fac_neg_nr      /0x2c kavie 20131211
SP0A19_write_cmos_sensor(0xea,0x14);//sharp_fac_pos_dummy  //0x18 kavie 20131211
SP0A19_write_cmos_sensor(0xef,0x18);//sharp_fac_neg_dummy  //0x1c kavie 20131211
SP0A19_write_cmos_sensor(0xeb,0x10);//sharp_fac_pos_low     //0x15 kavie 20131211
SP0A19_write_cmos_sensor(0xf0,0x14);//sharp_fac_neg_low    //0x18 kavie 20131211

SP0A19_write_cmos_sensor(0xfd,0x01);
SP0A19_write_cmos_sensor(0xa0,0x79);//0x85 kavie 20131211 for dif LED
SP0A19_write_cmos_sensor(0xa1,0x00);
SP0A19_write_cmos_sensor(0xa2,0x06);//0xFB kavie 20131211 for dif LED
SP0A19_write_cmos_sensor(0xa3,0xf3);
SP0A19_write_cmos_sensor(0xa4,0x73);//0x8e kavie 20131211 for dif LED
SP0A19_write_cmos_sensor(0xa5,0x19);
SP0A19_write_cmos_sensor(0xa6,0x00);
SP0A19_write_cmos_sensor(0xa7,0xda);//0xDA kavie 20131211 for dif LED
SP0A19_write_cmos_sensor(0xa8,0xa6);//0xA6 kavie 20131211 for dif LED
...
SP0A19_write_cmos_sensor(0xd3,0x82);
SP0A19_write_cmos_sensor(0xd4,0x82);
...
BOOL SP0A19_set_param_wb(UINT16 para)
{
	...
	{            
		...
		case AWB_MODE_CLOUDY_DAYLIGHT:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xd0);//bf	                                                       
			SP0A19_write_cmos_sensor(0x29,0x60);//89		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00);   
		    break;
		case AWB_MODE_DAYLIGHT:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xd8);//d0//0xbc	   f0	                                                       
			SP0A19_write_cmos_sensor(0x29,0x69);//9d//0x5d	   7d                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;
		case AWB_MODE_INCANDESCENT:	
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xa3);//0xbc		                                                       
			SP0A19_write_cmos_sensor(0x29,0xb0);//0xdd		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;  
		case AWB_MODE_FLUORESCENT:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xbc);//0xb5		                                                       
			SP0A19_write_cmos_sensor(0x29,0xa7);		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;  
		case AWB_MODE_TUNGSTEN:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0x86);//0xaf		                                                       
			SP0A19_write_cmos_sensor(0x29,0xe0);//0x99		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00);  
		    break;
		default:
			return KAL_FALSE;
...
void SP0A19_set_saturation(UINT16 para)
{
    switch (para)
    {
        ...
        case ISP_SAT_HIGH:
			SP0A19_write_cmos_sensor(0xd3,0x82+0x20); //outdoor 
			SP0A19_write_cmos_sensor(0xd4,0x82+0x20); //normal 
			SP0A19_write_cmos_sensor(0xd6,0x78+0x20); //dummy
			SP0A19_write_cmos_sensor(0xd7,0x68+0x20); //low light
             break;
			 
        case ISP_SAT_LOW:
			SP0A19_write_cmos_sensor(0xd3,0x82-0x20); 
			SP0A19_write_cmos_sensor(0xd4,0x82-0x20); 
			SP0A19_write_cmos_sensor(0xd6,0x78-0x20); 
			SP0A19_write_cmos_sensor(0xd7,0x68-0x20);
             break;
...
void SP0A19_set_brightness(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        default:
			SP0A19_CurrentStatus.iBrightness = ISP_BRIGHT_MIDDLE;
			SP0A19_write_cmos_sensor(0xdc,0x00); //0x00
             break;
    }
