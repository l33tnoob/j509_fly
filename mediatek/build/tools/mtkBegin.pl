...
printf("jinhaijian mtkBegin.pl copy vendor\/ragentek\/${prj} folder into alps\/out\/target\/product\/\n");
...
&p_system("cp -r vendor/ragentek/${prj}/bin out/target/product/system/bin/");
